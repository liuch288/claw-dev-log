...
|------|---------|------|-----|----------|----------|------|------|------|
| 2026-04-11 | CLQ-87 | rbt | [CLQ-87: Adapt PEU subclasses to new framework](https://github.com/liuch288/rbt/pull/36) | ✅ 可合并 | 0 | 1 | 2 | pd.concat 列名冲突风险（轻微）；价格来源语义变化确认是有意为之；多档探测逻辑改进 |
